...
set files [list \
 [file normalize "${origin_dir}/../target/Hello.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Hello" -objects $obj
...
set file "[file normalize "$origin_dir/ch1-ex-arty-a7-100.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "ch1-ex-arty-a7-100.xdc"
