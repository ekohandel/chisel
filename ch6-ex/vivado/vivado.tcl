...
set files [list \
 [file normalize "${origin_dir}/../target/Counter.v"] \
]
...
set file "[file normalize "$origin_dir/ch6-ex-arty-a7-100.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "ch6-ex-arty-a7-100.xdc"
